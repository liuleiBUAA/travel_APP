...
class RouteService:
    ...
    def _attach_images(self, itinerary: List[Dict[str, Any]], cities: List[str] = None) -> List[Dict[str, Any]]:
        ...
        for day in itinerary:
            images = index.match(day.get("activity", ""), seen=seen, cities=city_set)
            if images:
                day["images"] = images
            ...
            stay = day.get("stay", "")
            city_pb = pb_index.get_city(stay) if stay not in guided_cities else None
            if city_pb:
    ...
    def recommend_route(self, month: int, days: int,
        ...
        if csv_path and Path(csv_path).exists():
            ...
            return {
                ...
                "itinerary": self._attach_images(itinerary, cities=optimized_nodes),
    ...
    def generate_from_cities(self, cities: List[str],
        ...
        try:
            ...
            return {
                ...
                "total_days": total_days,
                "itinerary": self._attach_images(itinerary, cities=optimized_cities),  # ⭐完整的Day-by-Day行程
                "days_per_city": days_per_city,
                "unique_cities": unique_cities,
    ...
    def _generate_simple_route(self, cities: List[str]) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_days": total_days,
            "itinerary": self._attach_images(itinerary, cities=cities),
    ...
    def get_destination_structure(self) -> Dict[str, Any]:
        ...
        structure = {
            ...
            "China": {
                "name": "国内",
                # 顺序 = 小程序展示顺序：4 个直辖市在前，其余省份自北向南，港澳压尾
                "countries": {
                    "北京": "北京_destinations.json",
                    "上海": "上海_destinations.json",
                    "重庆": "重庆_destinations.json",
                    "天津": "天津_destinations.json",
                    "黑龙江": "黑龙江_destinations.json",
                    "吉林": "吉林_destinations.json",
                    "新疆": "新疆_destinations.json",
                    "辽宁": "辽宁_destinations.json",
                    "内蒙古": "内蒙古_destinations.json",
                    "宁夏": "宁夏_destinations.json",
                    "河北": "河北_destinations.json",
                    "山西": "山西_destinations.json",
                    "山东": "山东_destinations.json",
                    "青海": "青海_destinations.json",
                    "甘肃": "甘肃_destinations.json",
                    "河南": "河南_destinations.json",
                    "陕西": "陕西_destinations.json",
                    "江苏": "江苏_destinations.json",
                    "安徽": "安徽_destinations.json",
                    "四川": "四川_destinations.json",
                    "湖北": "湖北_destinations.json",
                    "浙江": "浙江_destinations.json",
                    "西藏": "西藏_destinations.json",
                    "江西": "江西_destinations.json",
                    "湖南": "湖南_destinations.json",
                    "贵州": "贵州_destinations.json",
                    "福建": "福建_destinations.json",
                    "云南": "云南_destinations.json",
                    "广东": "广东_destinations.json",
                    "广西": "广西_destinations.json",
                    "海南": "海南_destinations.json",
                    "香港": "香港_destinations.json",
                    "澳门": "澳门_destinations.json",
                }
            }
        }
        return structure
