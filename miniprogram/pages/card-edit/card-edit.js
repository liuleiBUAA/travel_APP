...
Page({
    ...
    try {
      ...
      if (me && (me.success || me.user_id)) {
        ...
        this.setData({
          ...
          paceIndex: this.data.paceOptions.indexOf(me.travel_pace || ''),
  ...
  onPaceChange(e) { this.setData({ paceIndex: Number(e.detail.value) }) },
  ...
  async onSave() {
    ...
    try {
      const res = await api.updateProfile({
        ...
        travel_pace: d.paceIndex >= 0 ? d.paceOptions[d.paceIndex] : '',
