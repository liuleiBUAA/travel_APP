...
const CITY_GROUPS = {
  ...
  //      地点少的省不设分组，前端自动扁平展示
  '北京': [
    { icon: '🏯', title: '城区经典', cities: ['北京', '故宫·天安门', '颐和园', '天坛', '圆明园', '恭王府', '什刹海·南锣鼓巷', '798艺术区', '北京环球影城'] },
    { icon: '🧱', title: '长城·陵寝', cities: ['八达岭长城', '慕田峪长城', '箭扣长城', '司马台长城', '明十三陵'] },
    { icon: '⛰', title: '近郊山水', cities: ['古北水镇', '雁栖湖·怀柔', '红螺寺·怀柔', '十渡·房山', '云居寺·房山', '香山·西山', '潭柘寺·戒台寺', '龙庆峡·延庆', '玉渡山·延庆', '百花山·门头沟', '灵山', '白河湾·密云'] },
  ],
  '上海': [
    { icon: '🌉', title: '市区地标', cities: ['上海', '外滩', '陆家嘴', '豫园·城隍庙', '南京路·人民广场', '新天地·田子坊', '武康路·衡复风貌区', '上海博物馆·天文馆'] },
    { icon: '🎡', title: '郊区·主题', cities: ['上海迪士尼度假区', '朱家角', '佘山', '崇明岛', '临港·滴水湖', '松江广富林', '七宝老街'] },
  ],
  '天津': [
    { icon: '🏛', title: '市区风貌', cities: ['天津', '五大道', '意式风情区', '海河·天津之眼', '古文化街', '瓷房子', '滨海图书馆', '东疆湾沙滩'] },
    { icon: '⛰', title: '蓟州山区', cities: ['盘山·蓟州', '黄崖关长城', '独乐寺·蓟州', '九山顶·梨木台'] },
  ],
  '重庆': [
    { icon: '🌃', title: '主城网红', cities: ['重庆', '洪崖洞', '解放碑', '磁器口', '李子坝·轻轨穿楼', '鹅岭二厂', '南山一棵树'] },
    { icon: '🏞', title: '渝东南·武隆', cities: ['武隆天生三桥', '仙女山·武隆', '龚滩古镇·酉阳', '濯水古镇·黔江', '阿依河·彭水', '长江三峡·巫山'] },
    { icon: '🛕', title: '渝西·渝南', cities: ['大足石刻', '金佛山', '黑山谷·万盛', '四面山·江津'] },
  ],
  '香港': [
