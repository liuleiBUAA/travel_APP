...
PB = f"{ROOT}/playbooks/斐济"
IMG = f"{ROOT}/images"
OUT = "/home/ubuntu/.hermes-bot2/media_cache/fiji_verify"
...
targets = {
    "01_斐济离岛城市页.html": ("斐济离岛城市攻略.json","city"),
    "02_Cloud9海上酒吧.html": ("Cloud9海上酒吧.json","attraction"),
    "03_外岛跳岛游.html": ("外岛跳岛游.json","attraction"),
    "04_鲨鱼潜水.html": ("鲨鱼潜水.json","attraction"),
    "05_丛林滑索.html": ("丛林滑索.json","attraction"),
    "06_喷射快艇.html": ("喷射快艇.json","attraction"),
    "07_轮胎漂流.html": ("轮胎漂流.json","attraction"),
}
