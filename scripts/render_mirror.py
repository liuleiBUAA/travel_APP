...
PB = f"{ROOT}/playbooks/瑞士"
IMG = f"{ROOT}/images"
MAPS = f"{ROOT}/maps"
OUT = "/home/ubuntu/.hermes-bot2/media_cache/sw_verify2"
os.makedirs(OUT, exist_ok=True)

# ---- 图库索引（复刻后端 ImageIndex.images_for / first_image）----
manifest = json.load(open(f"{IMG}/瑞士/manifest.json", encoding="utf-8"))
...
targets = {
    "01_city_zurich.html": "苏黎世城市攻略.json",
    "02_city_lucerne.html": "卢塞恩城市攻略.json",
    "03_city_interlaken.html": "因特拉肯城市攻略.json",
    "04_city_geneva.html": "日内瓦城市攻略.json",
    "05_city_montreux.html": "蒙特勒城市攻略.json",
    "06_city_zermatt.html": "采尔马特城市攻略.json",
    "07_attr_jungfrau.html": "少女峰.json",
    "08_attr_grindelwald.html": "格林德尔瓦尔德.json",
    "09_attr_wengen.html": "翁根.json",
    "10_attr_lauterbrunnen.html": "劳特布龙嫩.json",
    "11_attr_rigi.html": "瑞吉山.json",
    "12_attr_chillon.html": "西庸城堡.json",
}
